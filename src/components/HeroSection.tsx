    ...
    >
      ...
      <div className="hero-content max-w-[1200px] w-full mx-auto px-10 relative z-10">
        <div className="flex flex-col items-center text-center">
          <h1 className="hero-title text-[clamp(48px,8vw,120px)] font-bold leading-[1.1] tracking-[-0.02em] text-[var(--foreground)] opacity-0 translate-y-[60px] animate-[heroFadeIn_1.2s_cubic-bezier(0.4,0,0.2,1)_forwards] delay-300">
            Visionary Design.<br />Digital Excellence.
          </h1>
          <p className="text-xl font-medium tracking-tight text-[var(--foreground)]/40 mt-12 mb-16 animate-fade-up delay-500 uppercase">
          ...
          <div className="flex flex-wrap gap-8 justify-center items-center animate-fade-up delay-700">
            ...
            <a href="#portfolio" className="btn-arrow group text-[var(--foreground)]/60 hover:text-[var(--foreground)]">
