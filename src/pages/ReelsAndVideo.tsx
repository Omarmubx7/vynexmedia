            ...
            <div className="grid lg:grid-cols-12 gap-24">
              ...
              <div className="lg:col-span-12 mb-32">
                ...
                <h1 className="text-5xl md:text-9xl font-black tracking-extratight text-black uppercase italic leading-[0.8] mb-12">
                  Kinetic <br /> <span className="text-primary not-italic text-outline text-black">Narrative.</span>
                </h1>
              ...
              <div dir="rtl" className="lg:col-span-8 space-y-24">
                <section>
                  <h2 className="text-4xl font-black tracking-extratight text-black uppercase italic mb-8">قوة الحركة</h2>
                  <p className="text-2xl font-bold tracking-tight text-black/60 leading-relaxed uppercase">
                    في عالم السرعة، الفيديو هو الملك. نحن نصنع ريلز ومحتوى فيديو يتجاوز مجرد المشاهدة ليصل إلى مرحلة التأثير والانتشار. ريلز تجذب الانتباه في ثوانٍ.
                  </p>
                </section>

                <div className="grid md:grid-cols-2 gap-8">
                  {[
                    { title: 'ريلز احترافية', desc: 'محتوى مُصمم للانتشار والنمو' },
                    { title: 'مونتاج فني', desc: 'إيقاع يتناسب مع روح علامتك' },
                    { title: 'صوت عالي الجودة', desc: 'هندسة صوتية تجذب الحواس' },
                    { title: 'تحسين المنصات', desc: 'تنسيقات مثالية لـ TikTok و Instagram' },
                  ].map((item, idx) => (
              ...
              <div className="lg:col-span-4 lg:sticky lg:top-48 h-fit">
                <div className="p-10 bg-black text-white rounded-sm">
                  <h3 className="text-2xl font-black tracking-extratight uppercase italic mb-8">Go Viral</h3>
                  <p className="text-white/40 font-bold uppercase text-[12px] tracking-widest mb-10">باقات الفيديو تبدأ من 80 دينار</p>
                  <a
