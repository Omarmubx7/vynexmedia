            ...
            <div className="grid lg:grid-cols-12 gap-24">
              ...
              <div className="lg:col-span-12 mb-32">
                ...
                <h1 className="text-5xl md:text-9xl font-black tracking-extratight text-black uppercase italic leading-[0.8] mb-12">
                  Visual <br /> <span className="text-primary not-italic text-outline text-black">Flavour.</span>
                </h1>
              ...
              <div dir="rtl" className="lg:col-span-8 space-y-24">
                <section>
                  <h2 className="text-4xl font-black tracking-extratight text-black uppercase italic mb-8">فن تظهير المذاق</h2>
                  <p className="text-2xl font-bold tracking-tight text-black/60 leading-relaxed uppercase">
                    نحن لا نصور الأطباق فحسب، بل نصور التجربة. من البخار الصاعد إلى الملمس الحسي للمكونات، نجعل كل وجبة تبدو كلوحة فنية تستحق التذوق.
                  </p>
                </section>

                <div className="grid md:grid-cols-2 gap-8">
                  {[
                    { title: 'تصوير الأطباق', desc: 'إضاءة سينمائية تبرز التفاصيل' },
                    { title: 'صور الأجواء', desc: 'نقل روح المكان والديكور' },
                    { title: 'سرعة التسليم', desc: 'نحن نعلم أن المحتوى الطازج هو الأفضل' },
                    { title: 'رؤية فنية', desc: 'تكوين كلاسيكي وعصري للغذاء' },
                  ].map((item, idx) => (
              ...
              <div className="lg:col-span-4 lg:sticky lg:top-48 h-fit">
                <div className="p-10 bg-black text-white rounded-sm">
                  <h3 className="text-2xl font-black tracking-extratight uppercase italic mb-8">Savor Success</h3>
                  <p className="text-white/40 font-bold uppercase text-[12px] tracking-widest mb-10">استشارة مجانية للمطاعم</p>
                  <a
